...
class TrajectoryEncoder(layers.Layer):
    ...
    def call(self,traj_inputs,training=None):
        ...
        print("traj_inputs: ", traj_inputs.shape)
...
class TrajectoryAndContextEncoder(tf.keras.Model):
    ...
    def call(self,inputs,training=None):
        ...
        print("hola 2... outputs: ", len(outputs))
        print("hola 2... outputs: ", outputs[0].shape)
        print("hola 2... outputs: ", len(outputs[1]))
        print("hola 2... outputs: ", outputs[1][0].shape)
        print("hola 2... outputs: ", outputs[1][1].shape)
        print("hola 2... outputs: ", len(outputs[2]))
        print("hola 2... outputs: ", outputs[2][0].shape)
        print("hola 2... outputs: ", outputs[2][1].shape)
...
class TrajectoryDecoder(tf.keras.Model):
    ...
    def call(self, inputs, training=None):
        ...
        print("Hola 5... dec_input: ", dec_input.shape)
        decoder_inputs_emb = self.traj_xy_emb_dec(dec_input)
        print("Hola 5... decoder_inputs_emb: ", decoder_inputs_emb.shape)
        # context: [N,1,h_dim]
        ...
        print("Hola 5... outputs: ", len(outputs))
        # Last h,c states
        cur_states = outputs[1:3]
        print("Hola 5... cur_states[0]: ", cur_states[0].shape)
        ...
        print("Hola 5... decoder_latent: ", decoder_latent.shape)
        ...
        print("Hola 5... self.h_to_xy(decoder_latent): ", self.h_to_xy(decoder_latent).shape)
    ...
    def batch_step(self, batch_inputs, batch_targets, metrics, training=True):
        ...
        with tf.GradientTape() as g:
            ...
            if self.add_social:
                ...
                print("Hola 3... context: ", context.shape)
                print("Hola 3... traj_last_states: ", len(traj_last_states))
                print("Hola 3... traj_last_states: ", len(traj_last_states[0]))
                print("Hola 3... traj_last_states: ", traj_last_states[0][0].shape)
                print("Hola 3... traj_last_states: ", traj_last_states[0][1].shape)
                print("Hola 3... traj_last_states: ", len(traj_last_states[1]))
                print("Hola 3... traj_last_states: ", traj_last_states[1][0].shape)
                print("Hola 3... traj_last_states: ", traj_last_states[1][1].shape)
            ...
            for k in range(self.output_samples):
                ...
                print("Hola 4... dec_input: ", dec_input.shape)
                ...
                for t in range(0, batch_targets.shape[1]):
                    ...
                    print("Hola 4... t: ", t)
                    print("Hola 4... t_pred: ", t_pred.shape)
                    print("Hola 4... dec_states: ", len(dec_states))
                    print("Hola 4... dec_states: ", len(dec_states[0]))
                    print("Hola 4... dec_states: ", dec_states[0][0].shape)
                    print("Hola 4... dec_states: ", dec_states[0][1].shape)
                    print("Hola 4... dec_states: ", len(dec_states[1]))
                    print("Hola 4... dec_states: ", dec_states[1][0].shape)
                    print("Hola 4... dec_states: ", dec_states[1][1].shape)
