...
class OpticalFlowSimulator_obstacles(object):
    ...
    def plot_flow(self,trajectory,neighbors_trajectory,optical_flow,visible_neighbors,visible_obstacles,obstacles):
        ...
        for seq_pos in range(1,7):
            ...
            plt.ylim((0,3.14))
            plt.ylim((-1,1))
        plt.savefig('/home/andrea/of-sampl-obstacles.pdf')
    ...
    def compute_opticalflow_seq(self,Id,obs_traj,neighbors,obstacles):
        ...
        # only is use when we work with all neigbors
        ...
        for i in range(sequence_length):
            ...
            for other_ped_index in range(mnp):
                ...
                if(i==0):
                    ...
                    if(frame_pos[other_ped_index,0]==0):#if(other_x_pos==0.0 and other_y_pos==0.0):
                        vel_other = [0,0]
                ...
                # Inside the sequence
                    ...
                    if(frame_ant[other_ped_index,0]==0):#if(other_x_ant ==0.0 and other_y_ant == 0.0):
